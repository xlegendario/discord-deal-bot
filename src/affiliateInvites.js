    ...
    const embed = new EmbedBuilder()
      ...
      .setDescription(
        [
          ...
          "",
          "**PRO TIP:** If you help us secure a partnership with another server (e.g. cookgroups or WTB servers), we’ll use **your personal invite link** in the webhook posts.",
          "So all incoming members are credited to you! 👀",
          "",
          "**Important**",
